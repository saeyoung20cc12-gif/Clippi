...
대부분의 북마크 앱은 저장 이후를 돕지 않습니다. Clippi는 저장 직후부터 시작합니다. AI가 링크의 내용을 파악해 제목을 짧게 요약하고, 어떤 소분류에 넣으면 좋을지 추천합니다. 북마크가 쌓여도 직접 정리할 필요 없이 카테고리 안에서 읽기 좋은 상태로 유지됩니다.
...
**AI 자동 정리 (Gemini)**
- 제목 자동 요약 — 링크의 내용을 읽고 짧고 명확한 제목으로 축약
...
lib/
  ...
  screens/         HomeScreen, CategoryScreen, AddBookmarkSheet
assets/
